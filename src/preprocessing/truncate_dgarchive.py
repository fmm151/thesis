...
# output_folder = '../../files/dga_10K'
#
#
# # Function to randomly select up to 10,000 rows from a CSV file
# def random_sample_csv(input_file, output_file, num_rows=10000):
...
#         random_sample = df.sample(n=num_rows)
...
#         random_sample_csv(in_file, out_file, num_rows=10000)

folder_path = '../../files/dga_10K'
...
merged_file_path = '../../files/dga_10K/dga_10K_concat.csv'
