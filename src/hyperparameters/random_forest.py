...
def train_and_test_model(X_train, y_train, X_test, y_test):
    ...
    # os.remove("../../files/results/results_rf.csv")
    open("../../files/results/results_rf.csv", "w").close()

    for estimators in range(10, 210, 10):
        for depth in range(10, 210, 10):
            ...
            with open('../../files/results/results_rf.csv', 'a') as f:
                f.write(to_write + "\n")
            # fdw.write(to_write + "\n")
